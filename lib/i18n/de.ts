...
export const de: Dict = {
  ...
  voices: {
    ...
    stepLabel: "Schritt {n} von 5",
    step1Title: "Benenne die Stimme",
    step1Hint: "Gib dieser inneren Stimme einen Namen. Es kann alles sein — Der Schummler, Der Krieger, Der Stille.",
    step1ExistingTitle: "Oder bestehende Stimme aktualisieren",
    step1Or: "oder neue erstellen",
    step1UseThis: "Aktualisieren →",
    step1NameLabel: "Name der neuen Stimme",
    step1NamePlaceholder: "z. B. Der Schummler, Der Krieger…",
    nameRequired: "Bitte gib einen Namen ein.",
    nameTooLong: "Name darf maximal 60 Zeichen lang sein.",
    step2Title: "Verorte sie im Körper",
    step2BodyHint: "Tippe auf die Körperbereiche, in denen du diese Stimme spürst. Dann stelle Ton und Lautstärke ein.",
    toneLow: "Tief",
    toneHigh: "Hoch",
    volumeLow: "Flüstern",
    volumeHigh: "Laut",
    step3Title: "Form, Farbe & Größe",
    step3Hint: "Gib der Stimme eine visuelle Identität.",
    step3ShapeLabel: "Form",
    step3ColorLabel: "Farbe",
    step3SizeLabel: "Größe",
    step3CustomPrompt: "Beschreibe die individuelle Form…",
    step3PreviewName: "Deine Stimme",
    step4Title: "Im Raum platzieren",
    step4Hint: "Wo lebt diese Stimme gerade? Tippe, um sie zu positionieren. Dann setze den blauen Puck dorthin, wo du sie haben möchtest.",
    step5Title: "Wann hilft sie?",
    step5Hint: "Wähle alle Situationen aus, in denen diese Stimme auftaucht und etwas Nützliches tut.",
    step5InYourWords: "In deinen eigenen Worten",
    step5InYourWordsPlaceholder: "Beschreibe, wann diese Stimme auftaucht und was sie für dich tut…",
    step5MinChars: "Wähle mindestens eine Situation oder schreibe deine eigene (min. 10 Zeichen).",
    step5SaveBtn: "Stimme speichern →",
    continueBtn: "Weiter →",
    saving: "Speichern…",
