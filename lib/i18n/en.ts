...
export const en = {
  ...
  voices: {
    ...
    // Wizard — Step 1
    step1Title: "Name the voice",
    step1Hint: "Give this inner voice a name. It can be anything — The Cheater, The Warrior, The Quiet One.",
    step1ExistingTitle: "Or update an existing voice",
    step1Or: "or create new",
    step1UseThis: "Update →",
    step1NameLabel: "New voice name",
    step1NamePlaceholder: "e.g. The Cheater, The Warrior…",
    nameRequired: "Please enter a name.",
    nameTooLong: "Name must be 60 characters or fewer.",
    // Wizard — Step 2
    step2Title: "Locate it in your body",
    step2BodyHint: "Tap the regions where you feel this voice. Then set its tone and volume.",
    toneLow: "Low",
    toneHigh: "High",
    volumeLow: "Whisper",
    volumeHigh: "Loud",
    // Wizard — Step 3
    step3Title: "Shape, colour & size",
    step3Hint: "Give the voice a visual identity.",
    step3ShapeLabel: "Shape",
    step3ColorLabel: "Colour",
    step3SizeLabel: "Size",
