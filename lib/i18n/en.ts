...
export const en = {
  ...
  today: {
    ...
    reflectionCardLabel: "From your coach",
    reflectionCardBodyMany: "{n} reflections are waiting for you",
    reflectionCardViewAll: "View all →",
  },
  ...
  reflections: {
    pageLabel: "REFLECTIONS",
    title: "From your coach",
    emptyTitle: "Nothing here yet",
    emptyBody: "Your coach hasn't sent you any reflections yet.",
    progress: "{done} of {total} answered",
    visibilityNotice: "Your coach can read your answers to these.",
    framingQuote: "There are no perfect answers. Choose the questions that feel most alive, write honestly, and notice where certainty, discomfort or resistance appears.",
    commitmentLabel: "Take this with you",
    ...
    noteSend: "Send",
    noteSending: "Sending…",
    noteRecordVoice: "Record voice",
    noteReRecord: "Re-record",
    noteStopRecording: "Stop recording",
    noteMicDenied: "Microphone access denied",
    noteSendError: "Couldn't send — try again.",
    notFoundTitle: "Not found",
    notFoundBody: "This reflection isn't available.",
    backToList: "← All reflections",
    you: "You",
  ...
  coach: {
    ...
    reflectionSetsTitle: "Reflection sets",
    reflectionSetsBody: "Write a personal set of open-ended questions for this athlete to answer at their own pace.",
    reflectionNewBtn: "+ New reflection set",
    reflectionNoSetsYet: "No reflection sets yet.",
    reflectionTitleLabel: "Title",
    reflectionTitlePlaceholder: "e.g. Becoming a coach",
    reflectionIntroLabel: "Intro (optional)",
    reflectionIntroPlaceholder: "A short framing paragraph shown above the questions…",
    reflectionQuestionsLabel: "Questions",
    reflectionPromptPlaceholder: "Question…",
    reflectionHelperPlaceholder: "Helper text (optional)…",
    reflectionKindText: "Text",
    reflectionKindCommitment: "Commitment",
    reflectionAddQuestion: "+ Add question",
    reflectionRemoveQuestion: "Remove",
    reflectionMoveUp: "Move up",
    reflectionMoveDown: "Move down",
    reflectionSaveDraft: "Save draft",
    reflectionSaveChanges: "Save changes",
    reflectionSend: "Send to athlete",
    reflectionSendConfirm: "Send this to the athlete? They'll be notified.",
    reflectionSaved: "Saved ✓",
    reflectionSent: "Sent ✓",
    reflectionError: "Couldn't save — try again.",
    reflectionSendError: "Couldn't send — try again.",
    reflectionNeedsQuestion: "Add at least one question first.",
    reflectionNeedsTitle: "Give this set a title.",
    reflectionStatusDraft: "Draft",
    reflectionStatusSent: "Sent",
    reflectionStatusArchived: "Archived",
    reflectionArchiveBtn: "Archive",
    reflectionRestoreBtn: "Restore",
    reflectionEditBtn: "Edit",
    reflectionCancel: "Cancel",
    reflectionAnswersHeading: "Athlete's answers",
    reflectionNoAnswer: "No answer yet",
  },
} as const;
