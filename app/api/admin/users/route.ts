...
const PROFILE_SELECT = [
  ...
  "coach_id", "coach_code", "coach_status", "coach_application", "coach_notes", "meet_date",
...
const ADMIN_PATCHABLE = ["plan_tier", "course_access", "test_access", "ai_access", "translator_access", "coach_id", "role", "coach_code", "coach_status", "coach_notes"] as const;
