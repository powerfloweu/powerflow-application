...
const PROFILE_SELECT = [
  ...
  "plan_tier", "course_access", "test_access", "ai_access", "onboarding_complete", "created_at",
...
const ADMIN_PATCHABLE = ["plan_tier", "course_access", "test_access", "ai_access", "coach_id", "role", "coach_code"] as const;
