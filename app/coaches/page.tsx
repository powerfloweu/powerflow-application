...
const COACHES: Coach[] = [
  {
    ...
    bio: "David built PowerFlow after 600+ hours of practice with strength athletes, distilling sport psychology into tools any athlete can apply: visualization scripts, pre-meet routines, competition anxiety work and individualized mental skill sets. Works with athletes across IPF, USAPL and EPF.",
