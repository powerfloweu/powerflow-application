...
const COACHES: Coach[] = [
  {
    ...
    bio: "Built PowerFlow after 600+ hours of practice with strength athletes. Tool-oriented approach: individualized technique selection, pre-competition routines, visualization scripting and meet-day preparation. Works with athletes across IPF, USAPL and EPF.",
  ...
  },
  {
    ...
    initials: "CT",
    title: "Mental Performance Coach",
    bio: "Self-talk specialist. Identifies and reframes the internal dialogue patterns that interfere with performance, then reinforces the cognitive habits that produce reliable results under pressure.",
  ...
  },
  {
    ...
    bio: "PhD candidate at Florida State University and 2× USAPL National Champion. Specialises in confidence, attention control, anxiety regulation and performing under pressure. Works with D1 and elite-level athletes.",
    instagram: "kateco220",
